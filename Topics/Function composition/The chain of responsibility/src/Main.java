...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInRequestTag.combine(createDigest.combine(wrapInTransactionTag));
    ...
    interface RequestHandler {
        ...
        default RequestHandler combine(RequestHandler handler) {
            return req -> this.handle(handler.handle(req));
        }
    }
    /**
